{
 "cells": [
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "**D is an example of computing bias due the hiring system being biased against applications from varying backgrounds.** "
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "**This is human bias as the people who made the system were most likely from lighter-skinned backgrounds. This bias was unintentional as the programmers may have forgotten that darker skinned people would not be accounted for by the system due to the team being primarily light-skinned.**"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "**Another scenario of data collection in everyday situations is a phone recording our conversations and locations or social media keeping track of what content we like and appropriately adjusting their algorithms to better fit our preferences.**"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "**Answer-** Classifier correction can be used to provide a solution to this sitution. Classifier correction is commonly used in situations where a machine learning model shows bias towards certain groups (in this example, the model is biased towards overpolicing of certain neighborhoods). This method would work by fine-tuning the decision processes of the model to treat all demographics equally and avoid any biases. As a result, the use classifer correction will allow the algorithm to the law enforcement resources equally among all neighborhoods and prevent discrimination."
   ]
  }
 ],
 "metadata": {
